...
def posterior(x, n, P, Pr):
    """
    Calculates the posterior probability of obtaining the data `x` & `n`, given
    various hypothetical probabilities `P` of developing severe side effects.
    ...
    return likelihoods * Pr / np.sum(likelihoods * Pr)
