...
class NeuralNetwork:
    ...
    def forward_prop(self, X):
        ...
        Returns: A tuple of: 1) the activation of each neuron in the the hidden
            layer for each training example, and 2) the activation of the
            output neuron for each training example, respectively.
        """
